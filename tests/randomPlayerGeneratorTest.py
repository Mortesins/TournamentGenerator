...
class RandomPlayerGeneratorTest(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual(players[2].name,"C")
        self.assertEqual(players[3].name,"D")
        self.assertEqual(players[4].name,"E")
        playerGenerator = RandomPlayerGenerator(26)
        players = playerGenerator.generate()
        self.assertEqual(len(players),26)
        self.assertEqual(players[0].name,"A")
        self.assertEqual(players[25].name,"Z")
        playerGenerator = RandomPlayerGenerator(104)
        players = playerGenerator.generate()
        self.assertEqual(len(players),104)
        self.assertEqual(players[0].name,"AA")
        self.assertEqual(players[50].name,"BY")
        self.assertEqual(players[103].name,"DZ")
